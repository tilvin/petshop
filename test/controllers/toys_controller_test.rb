...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { matherial: @toy.matherial, name: @toy.name, pet_id: @toy.pet_id, price: @toy.price, size: @toy.size, weight: @toy.weight }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { matherial: @toy.matherial, name: @toy.name, pet_id: @toy.pet_id, price: @toy.price, size: @toy.size, weight: @toy.weight }
    assert_redirected_to toy_path(assigns(:toy))
  end
